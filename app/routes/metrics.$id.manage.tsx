...
import { MetricUpdateFormSchema, Metric } from "~/models/metric";
...
export async function action({ request }: ActionArgs) {
  ...
  let res = await handleUpdate(MetricUpdateFormSchema, formData, repo)
  return json(res)
}
...
export default function MetricManage() {
  const metric: Metric = useLoaderData<typeof loader>().entity
